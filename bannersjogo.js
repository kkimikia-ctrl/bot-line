// banners.js - Injeta o Cabeçalho e o Carrossel Infinito unificado
function carregarSistemaDeBanners(tituloPagina = "Central de Jogos", voltarUrl = "entretenimento.html") {
    
    // 1. Injeta o CSS padrão unificado
    ...
    // 2. Injeta o HTML do Cabeçalho e do Carrossel no topo
        ...
        <div class="banner-carousel">
            <div class="carousel-track" id="carouselTrack">
                <div class="ad-banner-card" onclick="registrarCliqueBanner('banner-jogo-1', 'fale-conosco.html')">
                    <div class="ad-placeholder-text"><span>🖼️ Anuncie Aqui</span><span style="font-size: 9px; color: #888; margin-top: 2px;">Anúncio 1</span></div>
                </div>
                <div class="ad-banner-card" onclick="registrarCliqueBanner('banner-jogo-2', 'fale-conosco.html')">
                    <div class="ad-placeholder-text"><span>🖼️ Anuncie Aqui</span><span style="font-size: 9px; color: #888; margin-top: 2px;">Anúncio 2</span></div>
                </div>
                <div class="ad-banner-card" onclick="registrarCliqueBanner('banner-jogo-3', 'fale-conosco.html')">
                    <div class="ad-placeholder-text"><span>🖼️ Anuncie Aqui</span><span style="font-size: 9px; color: #888; margin-top: 2px;">Anúncio 3</span></div>
                </div>
                <div class="ad-banner-card" onclick="registrarCliqueBanner('banner-jogo-4', 'fale-conosco.html')">
                    <div class="ad-placeholder-text"><span>🖼️ Anuncie Aqui</span><span style="font-size: 9px; color: #888; margin-top: 2px;">Anúncio 4</span></div>
                </div>
            </div>
        </div>
    `;
    ...
    // 3. Ativa a animação de rolagem infinita
